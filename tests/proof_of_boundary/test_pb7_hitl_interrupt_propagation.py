...
#
# Two test cases (framework Proof-of-Boundary PB-7 — HITL interrupt propagation):
#
...
#
# References:
#   Framework Proof-of-Boundary PB-7
#   Framework HITL Compliance (D6 pattern, hitl_allowed guard)
...
def test_pb7_hitl_interrupt_propagates() -> None:
    ...
    Covers Proof-of-Boundary PB-7 (first assertion):
...
def test_pb7_hitl_allowed_false_skips_interrupt() -> None:
    ...
    Covers HITL Compliance + the hitl_allowed production-readiness criterion:
